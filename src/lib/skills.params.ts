...
const MY_SKILLS = [
	s({
		...
		color: 'blue',
		description:
			`Python has been my most used language in my journey. I have used it for a variety of projects, from web development to machine learning.
	...
	s({
		...
		color: 'orange',
		description:
			`Rust has been my most recent endeavor. Appealing to me due to its amazing compiler and memory management, I have decided to pursue a 
	...
	s({
		...
		color: 'blue',
		description:
			`Java was the very first language I learned back in high school. The object oriented paradigm served as a catalyst to propell me
	...
	s({
		...
		color: 'yellow',
		description:
			`My introduction to frontend development occurred during my Stanford Summer Session. I learned HTML/CSS and Javascript in CS106B, and have since
	...
	s({
		...
		color: 'black',
		description:
			`I learned Flask taking CS 1998 at Cornell University. Since then, I have used Flask extensively starting with Cornell Hitch and earning second
	...
	s({
		...
		color: 'blue',
		description:
			`Through my work at Cornell University, I have learned how to use Docker to deploy my applications. I have used it to deploy my backend for Cornell Hitch and 
	...
	s({
		...
		color: 'blue',
		description:
			`Though a very broad skill to list, this year I have dove deep into the realm of machine learning. I have used it in my academic projects such as in 
	...
	s({
		...
		color: 'orange',
		description:
			`I was thrust into the world of functional programming throug CS3110 at Cornell University. Through that course, I have developed an OCaml interpreter, as well
